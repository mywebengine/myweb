 ...
 */
await Promise.all(self.__import__=new Map([["/descr.js", import('data:text/javascript;text,let setReqCmd,type_cache,reqCmd,incCmdName,setAsOneIdx,getIdx,setIdx,loadingCount,getProxy;import.meta.__imports__=Promise.all([self.__import__.get("/render/render.js"),self.__import__.get("/cache.js"),self.__import__.get("/config.js"),self.__import__.get("/dom.js"),self.__import__.get("/loading.js"),self.__import__.get("/proxy.js")]).then(arr=>{let m;m=arr[0];setReqCmd=m.setReqCmd;m=arr[1];type_cache=m.type_cache;m=arr[2];reqCmd=m.reqCmd;incCmdName=m.incCmdName;m=arr[3];setAsOneIdx=m.setAsOneIdx;getIdx=m.getIdx;setIdx=m.setIdx;m=arr[4];loadingCount=m.loadingCount;m=arr[5];getProxy=m.getProxy;});export const $srcById=new Map;export const srcById=new Map;export const srcBy$src=new WeakMap;export const descrById=self.mw_descrById||new Map;export let idCurVal=self.mw_idCurVal||0;export function getNewId(){return++idCurVal}export function createSrc(e,t,r,n){const s=getNewId();if(t===undefined){t=createDescr(e,s);const o=t.attr!==null?type_src(s,t,true,null,null,type_cache()):type_src(s,t,false,null,null,null);$srcById.set(s,e);srcById.set(s,o);srcBy$src.set(e,o);return o}t.srcIds.add(s);const o=t.attr!==null?type_src(s,t,true,r,n,type_cache()):type_src(s,t,false,null,null,null);$srcById.set(s,e);srcById.set(s,o);srcBy$src.set(e,o);if(!o.isCmd){return o}moveLoading(e,s);return o}export function createDescr(e,t){const r=getNewId(),n=createAttr(e);if(n.size===0){const s=type_descr(r,t,null,null);descrById.set(r,s);return s}const s=type_descr(r,t,n,new Set);let o=0;for(const[c,u]of n){const l=reqCmd.get(c);if(l.cmd.get$els){if(s.get$elsByStr===null){s.get$elsByStr=type_get$elsByStr()}s.get$elsByStr.set(c,type_get$elsByStrI(u,o))}o++;if(l.cmd.isCustomHtml&&s.isCustomHtml===false){s.isCustomHtml=true}if(l.cmd.isAsOne){if(s.asOnes===null){s.asOnes=new Set}s.asOnes.add(c)}}descrById.set(r,s);return s}function moveLoading(e,t){const r=loadingCount.get(e);if(r===undefined){return}loadingCount.set(t,r);loadingCount.delete(e)}function type_src(e,t,r,n,s,o){return{id:e,descr:t,isCmd:r,asOneIdx:n,idx:s,save:null,cache:o,scopeCache:getProxy({}),isMounted:false}}export function type_asOneIdx(e){return new Map(e)}export function type_idx(e){return new Map(e)}export function type_save(){return new Map}function type_descr(e,t,r,n){return{id:e,sId:t,attr:r,varIds:n,srcIds:new Set([t]),isCustomHtml:false,asOnes:null,get$elsByStr:null}}function type_get$elsByStr(){return new Map}function type_get$elsByStrI(e,t){return{expr:e,pos:t}}export function createAttr(e){const t=new Map,r=e.attributes,n=r.length;for(let e=0;e<n;e++){const s=r[e];if(setReqCmd(s.name)){t.set(s.name,s.value)}}return t}export function get$els(e,t,r){const n=srcBy$src.get(e).descr.attr.keys();let s=n.next();if(r!==""){for(;!s.done;s=n.next()){if(s.value===r){break}}}while(!s.done){const o=s.value,c=t.get(o);if(c!==undefined){return reqCmd.get(o).cmd.get$els(e,o,c.expr,c.pos)}s=n.next()}return[e]}export function get$first(e,t,r){const n=srcBy$src.get(e).descr.attr.keys();let s=n.next();if(r!==""){for(;!s.done;s=n.next()){if(s.value===r){break}}}while(!s.done){const o=s.value,c=t.get(r);if(c!==undefined){return reqCmd.get(r).cmd.get$first(e,r,c.expr,c.pos)}s=n.next()}return e}export function getNextStr(e,t){const r=e.descr.attr.keys();for(let e=r.next();!e.done;e=r.next()){if(e.value!==t){continue}e=r.next();if(e.done){return""}return e.value}return""}export function getAttrAfter(e,t){const r=new Map,n=getAttrItAfter(e.entries(),t,true);for(let e=n.next();!e.done;e=n.next()){r.set(e.value[0],e.value[1])}return r}export function getAttrItAfter(t,r,e){if(r===""){return t}if(e){for(let e=t.next();!e.done;e=t.next()){if(e.value[0]===r){return t}}return t}for(let e=t.next();!e.done;e=t.next()){if(e.value===r){return t}}return t}')],
["/cmd/if.js", import('data:text/javascript;text,let renderTag,type_req,type_animation,type_renderRes,p_target,ifCmdName,elseifCmdName,elseCmdName,switchCmdName,caseCmdName,defaultCmdName,foreachCmdName,incCmdName,reqCmd,$srcById,srcBy$src,getAttrAfter,get$els,get$first,getNextStr,show,hide,getIdx,getErr,eval2,q_eval2,kebabToCamelCase;import.meta.__imports__=Promise.all([self.__import__.get("/render/render.js"),self.__import__.get("/config.js"),self.__import__.get("/descr.js"),self.__import__.get("/dom.js"),self.__import__.get("/err.js"),self.__import__.get("/eval2.js"),self.__import__.get("/str.js")]).then(arr=>{let m;m=arr[0];renderTag=m.renderTag;type_req=m.type_req;type_animation=m.type_animation;type_renderRes=m.type_renderRes;m=arr[1];p_target=m.p_target;ifCmdName=m.ifCmdName;elseifCmdName=m.elseifCmdName;elseCmdName=m.elseCmdName;switchCmdName=m.switchCmdName;caseCmdName=m.caseCmdName;defaultCmdName=m.defaultCmdName;foreachCmdName=m.foreachCmdName;incCmdName=m.incCmdName;reqCmd=m.reqCmd;m=arr[2];$srcById=m.$srcById;srcBy$src=m.srcBy$src;getAttrAfter=m.getAttrAfter;get$els=m.get$els;get$first=m.get$first;getNextStr=m.getNextStr;m=arr[3];show=m.show;hide=m.hide;getIdx=m.getIdx;m=arr[4];getErr=m.getErr;m=arr[5];eval2=m.eval2;q_eval2=m.q_eval2;m=arr[6];kebabToCamelCase=m.kebabToCamelCase;});export const ifCmd={get$els(e,t,r,s){return if_get$els(ifCmdName,elseifCmdName,elseCmdName,e,t,r,s)},get$first(e,t,r,s){return if_get$first(ifCmdName,elseifCmdName,elseCmdName,e,t,r,s)},render(t){make$first(t,ifCmdName,elseifCmdName,elseCmdName);return eval2(t,t.$src,true).then(e=>if_render(t,e,ifCmdName,elseifCmdName,elseCmdName))},q_render(s,n,i){let m=0;while(i.has(m)){m++}const f=n.length;if(m===f){return null}return q_eval2(s,n,i).then(e=>{const t=new Array(f);do{const r=type_req(n[m].$src,s.str,s.expr,n[m].scope,s.sync);make$first(r,ifCmdName,elseifCmdName,elseCmdName);t[m]=if_render(r,e[m],ifCmdName,elseifCmdName,elseCmdName);while(i.has(++m));if(m===f){break}}while(true);return t})}};export const switchCmd={get$els(e,t,r,s){return if_get$els(switchCmdName,caseCmdName,defaultCmdName,e,t,r,s)},get$first(e,t,r,s){return if_get$first(switchCmdName,caseCmdName,defaultCmdName,e,t,r,s)},render(r){make$first(r,switchCmdName,caseCmdName,defaultCmdName);let e=true;for(const[s,n]of srcBy$src.get(r.$src).descr.attr){if(e){if(s===r.str){e=false}continue}const i=reqCmd.get(s);if(i.cmdName!==caseCmdName){continue}return eval2(r,r.$src,true).then(t=>{r.reqCmd=i;r.str=s;r.expr=n;return eval2(r,r.$src,true).then(e=>if_render(r,e,switchCmdName,caseCmdName,defaultCmdName,e=>e===t))})}throw getErr(new Error(">>>mw switch:01:Invalide structure: case-cmmand not found"),r.$src,r)}};async function if_render(s,n,e,i,m,f=e=>e,t){let c=f(n);if(c){const u=s.reqCmd.args[0];if(u){s.scope[p_target][kebabToCamelCase(u)]=n}}let[a,d,o]=makeShow(s,s.$src,s.str,c);const l=isSingle(srcBy$src.get(s.$src),s.str);if(l===-1){return type_renderRes(o===null,d,a,d,o)}for(let r=a.nextSibling;r!==null;r=r.nextSibling){const g=srcBy$src.get(r);if(g===undefined){continue}if(!g.isCmd){break}let e=true,t=0;for(const[C,N]of g.descr.attr){if(t++<l){continue}const $=reqCmd.get(C);if($.cmdName!==i&&$.cmdName!==m){break}e=false;if(c){[a]=makeShow(s,r,C,false);r=a;break}if($.cmdName===m){[a,d,o]=makeShow(s,r,C,true);r=a;break}const h=type_req(r,C,N,s.scope,s.sync);n=await eval2(h,r,true);if(c=f(n)){const u=h.reqCmd.args[0];if(u){s.scope[p_target][kebabToCamelCase(u)]=n}[a,d,o]=makeShow(h,r,C,true);r=a;n=true;break}[a,d,o]=makeShow(h,r,C,false);r=a;break}if(e){break}}return type_renderRes(o===null,d,a,d,o)}function make$first(e,t,r,s){let n=0;for(const m of srcBy$src.get(e.$src).descr.attr.keys()){if(m===e.str){break}n++}const i=if_get$first(t,r,s,e.$src,e.str,e.expr,n);if(reqCmd.get(e.str).cmdName===t){e.$src=i;return}for(const[m,f]of srcBy$src.get(i).descr.attr){const c=reqCmd.get(m);if(c.cmdName===t){e.reqCmd=c;e.str=m;e.expr=f;e.$src=i;i;return}}}function if_get$first(f,c,a,d,o,e,t,l){const u=o!==""&&reqCmd.get(o).cmdName===f;for(let m=d;m!==null;m=m.previousSibling){const g=srcBy$src.get(m);if(g===undefined){continue}if(!g.isCmd){break}let e=true,i=0;for(const C of g.descr.attr.keys()){const N=reqCmd.get(C);if(N.cmdName===incCmdName){i=0;continue}i++;if(u){if(C!==o){continue}}else if(N.cmdName===c||N.cmdName===a){if(i!==1){throw getErr(new Error(">>>mw if:make$first:01 Invalid structure: elseif and else command can be first in this attributes"),m)}e=false;break}else if(N.cmdName!==f){continue}if(l){l.str=C}let t=0,r=[],s="",n;const $=g.descr.attr.keys();for(let e=$.next();!e.done;e=$.next()){if(t===0){const C=e.value,N=reqCmd.get(C);if(N.cmdName===foreachCmdName){r.push([C,getIdx(g,C)])}}if(e.value!==o){continue}for(e=$.next();!e.done;e=$.next()){const C=e.value,N=reqCmd.get(C);if(s===""&&N.cmdName===incCmdName){if(getIdx(g,C)!==undefined){t++}}else if(t===0&&s===""&&N.cmdName===foreachCmdName){n=getIdx(g,C);if(n!==undefined){s=C}}}break}if(t!==0){for(m=m.previousSibling;m!==null;m=m.previousSibling){if(m.nodeType===8&&m.textContent==="inc_begin"){if(--t){continue}for(m=m.nextSibling;m!==null;m=m.nextSibling){const g=srcBy$src.get(m);if(g!==undefined&&g.isCmd){return m}}}}throw getErr(new Error(">>>mw if:make$first:02 Invalid structure: inc_begin not found"),d)}if(s!==""){const h=r.length;for(let e=m.previousSibling;e!==null;e=e.previousSibling){const p=srcBy$src.get(e);if(p===undefined||!p.isCmd){continue}const b=getIdx(p,s);if(b===undefined||n<b){return m}if(h>0){for(let e=0;e<h;e++){const y=r[e];if(getIdx(p,y[0])!==y[1]){return m}}}m=e;n=b}return m}return m}if(e){break}}throw getErr(new Error(`>>>mw if:ifGet$first:02 Invalid structure: if-command not found - str => "${o}"`),d)}function if_get$els(e,r,s,t,n,i,m){const f={str:""};let c=if_get$first(e,r,s,t,n,i,m,f);for(let e=srcBy$src.get(c);e!==undefined&&!e.isCmd&&c!==null;c=c.nextSibling,e=srcBy$src.get(c)){c=c.nextSibling}const a=srcBy$src.get(c),d=if_getNextStr(a,f.str),o=d!==""?get$els(c,a.descr.get$elsByStr,d):[c],l=isSingle(a,f.str);if(l===-1){return o}if(d!==""){c=o[o.length-1]}let u=[];for(c=c.nextSibling;c!==null;c=c.nextSibling){const a=srcBy$src.get(c);if(a===undefined){u.push(c);continue}if(!a.isCmd){return o}let e=true,t=0;const g=a.descr;for(const C of g.attr.keys()){if(t++<l){continue}const N=reqCmd.get(C);if(N.cmdName!==r&&N.cmdName!==s){break}e=false;const d=if_getNextStr(a,C),$=d!==""?get$els(c,g.get$elsByStr,d):[c];if($.length===1){if(u.length!==0){o.push(...u);u=[]}o.push(c);break}c=$[0].previousSibling;u=[];while(true){const a=srcBy$src.get(c);if(a===undefined){break}u.push(c);c=c.previousSibling}const h=u.length;if(h!==0){for(let e=h-1;e>-1;e--){o.push(u[e])}u=[]}c=o[o.push(...$)-1];break}if(e){return o}}return o}function isSingle(e,t){let r=0,s=false;for(const n of e.descr.attr.keys()){if(n===t){break}switch(reqCmd.get(n).cmdName){case ifCmdName:case elseifCmdName:case elseCmdName:case foreachCmdName:case caseCmdName:case defaultCmdName:r++;s=true;break;case incCmdName:r++;s=false;break}}return s?-1:r}function makeShow(t,r,s,e){const n=srcBy$src.get(r),i=if_getNextStr(n,s),m=i!==""?get$els(r,n.descr.get$elsByStr,i):[r],f=m.length,c=m[f-1];if(!e){for(let e=0;e<f;e++){r=m[e];if(r.nodeType===1){hide(t,r)}}return[c,null,null]}let a=null,d=null,o=true;for(let e=0;e<f;e++){r=m[e];if(r.nodeType===8){continue}if(a===null){const u=srcBy$src.get(r);if(u!==undefined&&u.isCmd){a=r;d=getAttrAfter(u.descr.attr,s)}}if(r.nodeName==="TEMPLATE"){show(t,r);o=false}}if(o){return[c,a,d]}const l=srcBy$src.get(a).id;t.sync.afterAnimations.add(type_animation(()=>renderTag($srcById.get(l),t.scope,d,t.sync),t.sync.local,0));return[c,null,null]}function if_getNextStr(e,t){return t!==switchCmdName?getNextStr(e,t):getNextStr(e,getNextStr(e,t))}')],
...
["/oset.js", import('data:text/javascript;text,export function oset(t,e,o){const n=t[e];if(typeof n!=="object"||n===null||typeof o!=="object"||o===null){t[e]=o;return true}if(Array.isArray(n)){return osetArray(t,e,o)}if(n instanceof Set){return osetSet(t,e,o)}if(n instanceof Map){return osetMap(t,e,o)}return osetObject(t,e,o)}function osetArray(t,e,o){if(!Array.isArray(o)){t[e]=o;return true}const n=t[e],r=n.length,f=o.length;for(let t=0;t<r&&t<f;t++){oset(n,t,o[t])}const s=r-f;if(s>0){n.splice(f,s);return true}for(let t=r;t<f;t++){n.push(o[t])}return true}function osetObject(t,e,o){if(typeof o!=="object"||o===null){t[e]=o;return true}const n=t[e];for(const r in n){if(!(r in o)){delete n[r]}}for(const r in o){oset(n,r,o[r])}return true}function osetSet(t,e,o){const n=t[e];if(o instanceof Set){for(const r of n){if(!o.has(r)){n.delete(r)}}for(const r of o){n.add(r)}}n.clear();return Reflect.set(t,e,o)}function osetMap(t,e,o){const n=t[e];if(o instanceof Map){for(const[r,f]of n){if(!o.has(r)){n.delete(r)}}for(const[r,f]of o){const s=n.get(r);if(typeof s==="object"){if(Array.isArray(s)){s.splice(0,s.length)}else if(s instanceof Set||s instanceof Map){s.clear()}else if(s!==null){for(const c of s){delete s[c]}}}n.set(r,f)}}n.clear();return Reflect.set(t,e,o)}export function del(t,e){const o=t[e];delete t[e];return o}export function ocopy(t){const e={};for(const o in t){e[o]=t[o]}return e}')],
["/loc.js", import('data:text/javascript;text,let oset;import.meta.__imports__=Promise.all([self.__import__.get("/oset.js")]).then(arr=>{let m;m=arr[0];oset=m.oset;});const trimSlashRe=new RegExp("(^/|/$)","g");export function getLoc(e,t=""){e=new URL(e);const r=parsePath(e.href,e.pathname,t);r.hash=parsePath(e.hash,e.hash.substr(1),t);for(const[o,a]of e.searchParams){r.query[o]=a}return r}export function setLoc(e){oset(self,"loc",getLoc(e))}function parsePath(e,t,r){const o=t.replace(trimSlashRe,"").split("/"),a=type_loc(e,t,o[0]||r,o);for(let e=o.length-1;e>0;e-=2){a.param[o[e-1]]=decodeURIComponent(o[e])}return a}function type_loc(e,t,r,o){return{href:e,path:t,name:r,args:o,param:{},query:{}}}')],
