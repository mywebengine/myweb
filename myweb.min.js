...
["/type.js", import('data:text/javascript;text,export function type(t){return new typeCheck(t)}function typeCheck(t){this.val=t}typeCheck.prototype={eq(t){if(this.val===t){return this}throw new Error("Value "+this.val+" !== "+t)},of(t){if(this.val instanceof t){return this}throw new Error("Value "+this.val+" isn\'t instanceof "+t)},elsOf(t){if(!Array.isArray(this.val)){throw new Error("Value "+this.val+" isn\'t array")}for(const r of this.val){if(!(r instanceof t)){throw new Error("Value "+r+", array items isn\'t instanceof "+t)}}return this},propsOf(t){if(typeof this.val!=="object"||this.val===null){throw new Error("Value "+this.val+" isn\'t object")}for(const r in this.val){if(!(this.val[r]instanceof t)){throw new Error("Value "+this.val[r]+", object props isn\'t instanceof "+t)}}return this},array(){if(Array.isArray(this.val)){return this}throw new Error("Value "+this.val+" isn\'t array")},object(){if(typeof this.val==="object"&&this.val!==null){return this}throw new Error("Value "+this.val+" isn\'t object")},bool(){if(this.val===true||this.val===false){return this}throw new Error("Value "+this.val+" isn\'t bool")},number(){if(typeof this.val==="number"){return this}throw new Error("Value "+this.val+" isn\'t number")},string(){if(typeof this.val==="string"){return this}throw new Error("Value "+this.val+" isn\'t string")},null(){if(this.val===null){return this}throw new Error("Value "+this.val+" isn\'t null")},notNull(){if(this.val!==null){return this}throw new Error("Value "+this.val+" is null")},undef(){if(this.val===undefined){return this}throw new Error("Value "+this.val+" isn\'t undefined")},notUndef(){if(this.val!==undefined){return this}throw new Error("Value "+this.val+" is undefined")},func(){if(typeof this.val==="function"){return this}throw new Error("Value "+this.val+" isn\'t function")},test(t){if(t(this.val)){return this}throw new Error("Value "+this.val+" didn\'t pass the functional test")}};')],
