...
export const orderCmdName = cmdPref + "order";
export const scopeCmdName = cmdPref + "scope";
export const htmlCmdName = cmdPref + "html";
export const textCmdName = htmlCmdName + cmdArgsBegin + "text";
...
export const forIdxAttrName = cmdPref + "for-idx";
export const incValAttrName = cmdPref + "inc-val";
